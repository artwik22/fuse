...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.93.0 (254b59607 2026-01-19) (Arch Linux rust 1:1.93.0-1.1)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.93.0 (254b59607 2026-01-19) (Arch Linux rust 1:1.93.0-1.1)";
#[allow(clippy::needless_raw_string_hashes)]
